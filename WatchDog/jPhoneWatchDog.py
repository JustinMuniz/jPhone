...
#	print("BCM 23 is high") # Debug status
#if GPIO.input(23) == GPIO.LOW:
#	print("BCM 23 is low") # Debug status

#print("Application initialized") # Debug status
